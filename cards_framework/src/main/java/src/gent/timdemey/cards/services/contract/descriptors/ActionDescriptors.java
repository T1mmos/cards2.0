...
public class ActionDescriptors
{
    ...
    private static final String ACTION_SHOWMENU_MP = "action.game.showmenump";
    ...
    public static final ActionDescriptor ad_showmenump = new ActionDescriptor(ACTION_SHOWMENU_MP);
