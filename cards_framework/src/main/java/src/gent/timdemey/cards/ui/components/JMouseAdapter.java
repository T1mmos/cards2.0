...
{
    private final List<IHasMouse> listeners;
    ...
    void add(IHasMouse listener)
    {
        this.listeners.add(listener);
    }
    
    void remove(IHasMouse listener)
    {
    ...
    private void foreach (Consumer<IHasMouse> action)
    {
        for (IHasMouse listener : listeners)
        {
