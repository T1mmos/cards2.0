...
/**
 * Listens to UDP on the network and notifies registered listeners 
 * of all received messages (string).
 * 
 * @author Timmos
 */
public final class UDP_ServiceResponder
{
    ...
    private void receiveLoop()
    {
        ...
        try
        {
            while (true)
            {
                ...
                _Logger.info("Waiting for UDP data...");
                dsocket.receive(packet_in);
                _Logger.info("Received some data.");
