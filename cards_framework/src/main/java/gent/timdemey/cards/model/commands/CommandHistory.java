...
public class CommandHistory
{
    ...
    public boolean canRedo()
    {
        ...
        {
            // a command must have been either unexecuted (it has been executed before) or
            // submitted
    ...
    {
        /*
         * if (execCounterRequested) { throw new
         * IllegalStateException("The current command counter is already requested for a command "
         * +
