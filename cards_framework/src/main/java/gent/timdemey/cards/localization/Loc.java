...
public class Loc {
    ...
    public static Locale [] AVAILABLE_LOCALES = new Locale [] {
        Locale.ENGLISH
    };
    ...
    private static String getPriv(String key)
    {
        ...
        {
            // isn't a programming error but a resource that is missing, so treat like a checked exception io unchecked
            value = null;
        }
        return value;
    }
