...
import gent.timdemey.cards.model.commands.C_Connect;
...
public abstract class AGameOperationsService implements IGameOperationsService {
    ...
    {
        return Services.get(IContextService.class).getThreadContext().getState().getCardGame();
    }
    ...
    public void startGame() {
        ...
        List<UUID> playerIds = getThreadContext().getState().getPlayers().getIds();
