...
/**
 * An abstract ISResource that implements caching for quick access to the
 ...
 * @param <T>
 */
public abstract class SResource<R> implements ISResource<R>
{
    public final UUID id;
    public final Resource<R> resource;
    private final Map<Dimension, R> cache;

    public SResource(UUID id, Resource<R> resource)
    {
        this.id = id;
